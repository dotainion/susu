class Susu{
    ...
    groupWallet = (groupId = ':groupId') => this._nested + 'wallet/' + groupId;
    updateGroupWallet = (groupId = ':groupId', memberId = ':memberId') => this._nested + 'update/wallet/' + groupId + '/' + memberId;
